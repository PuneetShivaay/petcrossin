...
import 'package:petcross/src/application/auth_service.dart';

import '../screens/code_screen.dart';
import '../screens/home_screen.dart';

final phoneLoginScreenProvider =
    AsyncNotifierProvider<PhoneLoginScreenNotifier, String>(
        PhoneLoginScreenNotifier.new);
  ...
  Future<void> loginWithPhoneNumber(
    ...
    if (phoneNumber.isEmpty) {
      state = AsyncValue.error(
          "please_enter_your_phone_number".tr(), StackTrace.empty);
    } else if (countryCode.isEmpty) {
      state = AsyncValue.error(
          "please_enter_your_country_code".tr(), StackTrace.empty);
      ...
      var result =
          await authService.signInWithPhone('+$countryCode$phoneNumber');
