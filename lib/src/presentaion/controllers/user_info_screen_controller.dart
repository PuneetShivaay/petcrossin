...
final userInfoScreenProvider =
    AsyncNotifierProvider<UserInfoScreenNotifier, String>(
        UserInfoScreenNotifier.new);
...
class UserInfoScreenNotifier extends AsyncNotifier<String> {
  ...
  Future<void> storeUserData(
    ...
    if (name.replaceAll(" ", "").length < 3) {
      ...
      state =
          AsyncValue.error("birthday_invalid_format".tr(), StackTrace.empty);
