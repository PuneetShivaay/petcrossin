...
import 'package:petcross/src/application/chat_service.dart';
import 'package:petcross/src/presentaion/states/user_state.dart';

import '../../../domain/chat_model.dart';

final chatProvider =
    AsyncNotifierProvider<ChatsTabNotifier, String>(ChatsTabNotifier.new);
...
class ChatsTabNotifier extends AsyncNotifier<String> {
  ...
  void sendTextMessage(String text, String receiverUserId) async {
    ...
    var result = ref.read(chatServiceProvider).sendTextMessage(
        text: text, recieverUserId: receiverUserId, senderUser: user!);
