...
import 'package:petcross/src/application/cards_service.dart';

import '../../states/cards_state.dart';

final cardsTabProvider =
    AsyncNotifierProvider<CardsTabNotifier, CardsState>(CardsTabNotifier.new);
