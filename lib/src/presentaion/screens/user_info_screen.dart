...
import 'package:petcross/src/presentaion/controllers/user_info_screen_controller.dart';
...
class _UserInfoScreenState extends ConsumerState<UserInfoScreen> {
  ...
  void initState() {
    ...
    subscription = ref.listenManual<AsyncValue>(
        userInfoScreenProvider, (_, state) => state.showDialogOnError(context));
                  ...
                  state.isLoading
                      ...
                      : CircleAvatar(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () =>
                                state.isLoading ? null : storeUserData(),
                          ),
                        ),
                ],
              )),
