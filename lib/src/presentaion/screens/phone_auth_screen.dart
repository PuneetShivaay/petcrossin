...
import 'package:petcross/src/presentaion/controllers/phone_login_controller.dart';
...
class _PhoneAuthScreenState extends ConsumerState<PhoneAuthScreen> {
  ...
  void initState() {
    ...
    subscription = ref.listenManual<AsyncValue>(phoneLoginScreenProvider,
  ...
  void sendCodeToPhone() async {
    await ref.read(phoneLoginScreenProvider.notifier).loginWithPhoneNumber(
        context, countryCodeController.text, phoneNumberController.text);
  }
