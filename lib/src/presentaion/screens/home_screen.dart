...
import 'package:petcross/src/presentaion/controllers/connection_controller.dart';
import 'package:petcross/src/presentaion/controllers/home_screen_controller.dart';
import 'package:petcross/src/presentaion/states/message_state.dart';
import 'package:petcross/src/presentaion/states/user_state.dart';

import '../../../common/helper/show_alert_dialog.dart';
import '../../../common/utils/coloors.dart';
import '../../../common/utils/petcross_icons.dart';
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    switch (state) {
      ...
      case AppLifecycleState.paused:
        ...
        break;
      default:
        break; // Added default case to handle all possible AppLifecycleState values
    }
  }
        ...
        appBar: AppBar(
          ...
          title: TabBar(
            ...
            tabs: [
              _buildTab(
                index: 0,
                icon: PetcrossIcons.iconfinder_icons_user2_1564535,
              ),
              _buildTab(
                index: 1,
                icon: PetcrossIcons.iconfinder_338_petcross_logo_4375488__1_,
              ),
              _buildTab(
                index: 2,
                icon: PetcrossIcons.iconfinder_message_01_186393,
              ),
            ],
            onTap: (index) {
