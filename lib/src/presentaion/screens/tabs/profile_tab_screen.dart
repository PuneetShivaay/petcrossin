                            ...
                            onTap: () {
                              Navigator.pushReplacementNamed(
                                  ...
                                  arguments: {
                                    'name': data.name,
                                    'age':
                                        "${data.age['day']}.${data.age['month']}.${data.age['year']}",
                                    'sex': data.sex,
                                    'city': data.city,
                                    'bio': data.bio,
                    ...
                    builder: (context) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            color: Colors.white,
                            border: Border.all(
                                color: Coloors.primaryColor, width: 2),
                            boxShadow: const [
                              BoxShadow(
                                  color: Colors.grey,
...
List<Quotes> quotes = [
  ...
  Quotes("i_meant_to_swipe_right".tr(),
      "get_unlimited_rewinds_with_tinder_plus".tr()),
  Quotes("stand_out_with_super_likes".tr(),
      "youre_3_times_more_likely_to_get_a_match".tr()),
  Quotes("increase_your_chances".tr(),
      "get_unlimited_likes_with_tinder_plus".tr()),
  Quotes("swipe_around_the_world".tr(),
      "passport_to_anywhere_with_tinder_plus".tr()),
];
