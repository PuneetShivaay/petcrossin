...
import 'package:petcross/common/utils/utils.dart';
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color: widget.user.isOnline
                                    ? const Color.fromARGB(255, 133, 222, 136)
                                    : Coloors.steelGray,
                    ...
                    Text(
                      ...
                      style: TextStyle(
                          shadows: [
                            Shadow(
                                color: widget.user.isPrime
                                    ? Coloors.sunnyYellow
                                    : Colors.black54,
                                offset: widget.user.isPrime
